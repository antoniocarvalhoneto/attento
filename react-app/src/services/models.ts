...
export type Account = { id: string; kind?: 'receivable' | 'payable'; unitId?: string; rentalPeriod?: string; professionalId: string; description: string; value: number; dueDate: string; status: string; paymentDate: string | null }
